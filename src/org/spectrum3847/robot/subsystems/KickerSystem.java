...
public class KickerSystem extends Subsystem {
	...
	public KickerSystem(String n, SpectrumSpeedControllerCAN sc, double maxVal, double minVal){
		super(n);
		speedController = sc;
		max = maxVal;
		min = minVal;
	...
	public KickerSystem(String n, int scCAN, int scPDP, double maxVal, double minVal){
		this(n, new SpectrumSpeedControllerCAN(new CANTalon(scCAN), scPDP), maxVal, minVal);
	}
	
	public KickerSystem(String n, int scCAN, int scPDP){
		this(n, new SpectrumSpeedControllerCAN(new CANTalon(scCAN), scPDP), 1, -1);
	}
	
	public KickerSystem(String n, SpectrumSpeedControllerCAN sc){
		this(n, sc, 1, -1);
	}
